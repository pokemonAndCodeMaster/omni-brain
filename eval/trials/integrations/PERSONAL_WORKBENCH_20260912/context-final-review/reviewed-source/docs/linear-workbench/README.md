...
本地已配置官方 Linear MCP 并通过 OAuth 登录。新 Codex 会话会加载配置；无需复制 token。本说明没有为 OpenCode 或 ChatGPT 项目自动配置指令。线上完整使用说明见[本地接续与文档联动](https://linear.app/yyhpokemonmaster/document/个人工作台本地接续与文档联动-e65cc831468f)。
