...
- 已验证的 V2 第一切片：后端指标目录、受控任务级聚合、比例筛选/排序和问题选项候选值；
...
V2 的后续切片尚未实现任务→日期→组→标注员下钻、Good/Bad 详情、总览卡片 V2 和
多图层图表 V2。实施顺序以 `docs/manual-qc-analysis-workbench-v2-design.md` 为准；不得把
当前 V1 卡片能力误写成 V2 已完成能力。
